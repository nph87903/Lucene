...
public class LuceneIndexAndSearchDemo {
	...
	public static void main(String[] args){
		...
		String text5 = "一个结合词典分词和文法分词的中文分词开源工具包。它使用了全新的正向迭代最细粒度切分算法。";
		...
		try {
			...
			//写入索引
			addDoc(iwriter,text,"10000");

			addDoc(iwriter,text2,"10001");

			addDoc(iwriter,text3,"10002");

			addDoc(iwriter,text4,"10003");
